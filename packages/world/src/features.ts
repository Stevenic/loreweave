...
const BIOME_FEATURES: Record<BiomeType, FeatureRule[]> = {
	...
	coast: [
		{ type: 'cliff', density: 0.08, step: 1 },
		{ type: 'tide_pool', density: 0.12, step: 1 },
		{ type: 'driftwood', density: 0.10, step: 2 },
		{ type: 'seaweed', density: 0.15, step: 3 },
		{ type: 'sea_shell', density: 0.10, step: 3 },
		{ type: 'pebbles', density: 0.08, step: 4 },
		{ type: 'seabirds', density: 0.06, step: 5 },
		{ type: 'salt_spray', density: 0.10, step: 5 },
	],
	hills: [
		{ type: 'boulder', density: 0.10, step: 1 },
		{ type: 'exposed_rock', density: 0.15, step: 1 },
		{ type: 'heather', density: 0.30, step: 2 },
		{ type: 'gorse', density: 0.15, step: 2 },
		{ type: 'low_scrub', density: 0.20, step: 3 },
		{ type: 'pebbles', density: 0.08, step: 4 },
		{ type: 'standing_stone', density: 0.02, step: 4 },
		{ type: 'fog', density: 0.08, step: 5 },
	],
	cavern: [
		{ type: 'stalactite', density: 0.20, step: 1 },
		{ type: 'stalagmite', density: 0.15, step: 1 },
		{ type: 'underground_pool', density: 0.08, step: 2 },
		{ type: 'cave_moss', density: 0.15, step: 3 },
		{ type: 'glowing_fungus', density: 0.10, step: 3 },
		{ type: 'crystal_formation', density: 0.05, step: 4, minElevation: 15 },
		{ type: 'bones', density: 0.03, step: 4 },
	],
	farmland: [
		{ type: 'crop_field', density: 0.35, step: 1 },
		{ type: 'fence', density: 0.10, step: 2 },
		{ type: 'orchard_tree', density: 0.08, step: 2 },
		{ type: 'pasture', density: 0.15, step: 3 },
		{ type: 'hay_bale', density: 0.05, step: 4 },
		{ type: 'scarecrow', density: 0.02, step: 4 },
		{ type: 'flowers', density: 0.10, step: 5 },
	],
	deep_forest: [
		{ type: 'massive_root', density: 0.20, step: 1 },
		{ type: 'ancient_tree', density: 0.35, step: 2 },
		{ type: 'thick_undergrowth', density: 0.25, step: 2 },
		{ type: 'hanging_vine', density: 0.15, step: 3 },
		{ type: 'mushrooms', density: 0.12, step: 3 },
		{ type: 'moss', density: 0.15, step: 3 },
		{ type: 'hollow_trunk', density: 0.04, step: 4 },
		{ type: 'canopy_shadow', density: 0.20, step: 5 },
	],
};
