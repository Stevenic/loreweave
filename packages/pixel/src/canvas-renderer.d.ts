 ...
 */
import type { EmitterConfig, PixelColor, PixelPalette, PixelScene, PixelSprite, PixelTile, PixelTilemap, PixelTileset } from '@loreweave/types';
 ...
 */
export declare function rasterizeSpriteFrame(sprite: PixelSprite, frameIndex: number, paletteRegistry: Map<string, PixelPalette>, paletteOverrides?: Record<string, PixelColor>): ImageData;
/**
 * Rasterize a tile to an ImageData at 1× scale.
 */
export declare function rasterizeTile(tile: PixelTile, tileWidth: number, tileHeight: number, entries: Record<string, PixelColor>): ImageData;
/**
 ...
 */
export declare function drawImageData(ctx: CanvasRenderingContext2D | OffscreenCanvasRenderingContext2D, imageData: ImageData, x: number, y: number, createCanvas: CanvasFactory, options?: {
    scale?: number;
    flipX?: boolean;
    flipY?: boolean;
    rotation?: number;
 ...
 */
export declare function renderScene(ctx: CanvasRenderingContext2D | OffscreenCanvasRenderingContext2D, scene: PixelScene, registry: AssetRegistry, createCanvas: CanvasFactory, state?: SceneState, options?: {
 ...
 */
export declare function renderSprite(ctx: CanvasRenderingContext2D | OffscreenCanvasRenderingContext2D, sprite: PixelSprite, createCanvas: CanvasFactory, options?: {
