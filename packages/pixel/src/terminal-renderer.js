...
function resolveEntries(palette, registry) {
...
function renderRows(decodedRows, entries) {
...
export function renderSpriteTerminal(sprite, registry, frame = 0) {
...
export function renderTileTerminal(tile, tileWidth, tileHeight, palette, registry) {
...
export function renderSpriteToTerminalString(sprite, registry, frame = 0) {
    return renderSpriteTerminal(sprite, registry, frame).join('\n');
}
/** Render a tile to a single string for printing. */
export function renderTileToTerminalString(tile, tileWidth, tileHeight, palette, registry) {
