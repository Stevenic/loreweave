...
export declare function renderSpriteTerminal(
	sprite: PixelSprite,
	registry?: Map<string, PixelPalette>,
	frame?: number,
): string[];
/** Render a single tile to terminal-ready ANSI lines. */
export declare function renderTileTerminal(
	tile: PixelTile,
	tileWidth: number,
	tileHeight: number,
...
export declare function renderSpriteToTerminalString(
	sprite: PixelSprite,
	registry?: Map<string, PixelPalette>,
	frame?: number,
): string;
/** Render a tile to a single string for printing. */
export declare function renderTileToTerminalString(
	tile: PixelTile,
	tileWidth: number,
	tileHeight: number,
	palette: string | PixelPalette,
