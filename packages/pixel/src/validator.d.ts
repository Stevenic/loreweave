 ...
 */
import type { EmitterConfig, PixelEmitter, PixelPalette, PixelScene, PixelSprite, PixelTilemap, PixelTileset } from '@loreweave/types';
...
export declare function validateSprite(sprite: PixelSprite, registry?: Map<string, PixelPalette>): ValidationResult;
/** Validate a PixelTileset against the spec. */
export declare function validateTileset(tileset: PixelTileset, registry?: Map<string, PixelPalette>): ValidationResult;
/** Validate a PixelTilemap against the spec. */
export declare function validateTilemap(tilemap: PixelTilemap, tilesetRegistry?: Map<string, PixelTileset>): ValidationResult;
